  ...
  const editor = useEditor(
    {
      extensions: [
        ...
        Placeholder.configure({
          placeholder: "Write your DBMS notes for this section...",
        }),
      ],
  ...
  return (
    <div className="bg-[#111827] border border-white/10 rounded-lg p-5 relative group">
      ...
      <input
        ...
        placeholder="Eg: Concept / Diagram / Query / Example"
...
const DbmsDetail = () => {
  ...
  useEffect(() => {
    (async () => {
      const data = await getDbmsNoteById(id);
      setNote(data);
    })();
  }, [id]);
