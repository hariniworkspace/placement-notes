...
} from "../services/systemDesignNoteService";
...
const SystemDesign = () => {
  ...
  const loadNotes = async () => {
    const data = await getSystemDesignNotes();
    setNotes(data);
  };
  ...
  const handleCreate = async () => {
    ...
    const newNote = await createSystemDesignNote(title);
    setShowCreate(false);
    setTitle("");
    navigate(`/system-design/${newNote._id}`);
  };
              ...
              <div className="flex items-center gap-4">
                <div className="flex items-center gap-3 bg-white/5 border border-white/10 rounded-lg px-4 py-2">
                  ...
                  <input
                    ...
                    placeholder="Search system design notes..."
            ...
            {filteredNotes.length === 0 ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 mt-6">
                {filteredNotes.map((n) => (
                  <div
                    key={n._id}
                    onClick={() => navigate(`/system-design/${n._id}`)}
