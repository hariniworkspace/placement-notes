  ...
  return (
    <div className="bg-[#111827] border border-white/10 rounded-lg p-5 relative group">
      ...
      <input
        ...
        placeholder="Eg: Key Points / Formula / Tricks"
...
const AptitudeNoteDetail = () => {
  ...
  useEffect(() => {
    (async () => {
      const data = await getAptitudeNoteById(id);
      setNote(data);
      setLoading(false);
    })();
  }, [id]);
...
export default AptitudeNoteDetail;
